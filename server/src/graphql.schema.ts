...
export interface IQuery {
    ...
    currencyByDates(startDate?: Nullable<string>, endDate?: Nullable<string>, valcode?: Nullable<string>): Nullable<Nullable<Currency>[]> | Promise<Nullable<Nullable<Currency>[]>>;
